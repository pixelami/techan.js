...
module.exports = function(d3_scale_linear, d3_time, d3_bisect, techan_util_rebindCallback, scale_widen, techan_scale_zoomable) {  // Injected dependencies
  ...
  var dailyTickMethod = [
      ...
      [d3_time.timeYear, 2, yearFormat],
      [d3_time.timeYear, 5, yearFormat],
      [d3_time.timeYear, 12, yearFormat]
    ],
    intradayTickMethod = [
  ...
  var dailyTickMethodUtc = [
      ...
      [d3_time.utcYear, 2, yearFormatUtc],
      [d3_time.utcYear, 5, yearFormatUtc],
      [d3_time.utcYear, 12, yearFormatUtc]
